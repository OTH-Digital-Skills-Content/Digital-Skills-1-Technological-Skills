...
Die Codespaces haben zufällig generierte Namen wie "fuzzy adventure" oder "expert space pancake". Sie können den Codespace durch Klick auf diesen Fantasienamen öffnen. Über dem Codespace steht eine Zeile, anhand derer Sie rausfinden können, zu welcher Aufgabe der Codespace gehört, z.B.:
  * ```OTH-Tech-Skills-Classroom50/technology-skills-erste-schritte-codespaces-ihrgithubusername``` ist der Codespace für dieses Tutorial
  * ```OTH-Tech-Skills-Classroom50/hello-ihrgithubusername``` ist der Codespace für die Aufgabe hello
  * usw.

## FAQs und Troubleshooting

Antworten auf häufige Fragen und Probleme (Recovery Mode, zu viele Codespaces, Submit-Verhalten, u.v.m.) finden Sie im Topic "FAQ & Troubleshooting" am Anfang des Kurses.
