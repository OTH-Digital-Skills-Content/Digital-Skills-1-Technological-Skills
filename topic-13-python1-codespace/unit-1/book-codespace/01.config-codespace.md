...
* Falls Sie Ihr replit-Limit verbraucht haben, ist Ihr Code nicht verloren. Klicken Sie dazu auf Ihr repl und laden den Inhalt des repls auf Ihren Rechner herunter. Öffnen Sie dann die entsprechende Python-Datei mit Ihrer Lösung und kopieren den Inhalt in die entsprechende Datei in Codespaces. Vgl. der folgende Screenshot für einen Download aus replit.
![04_replit_download](img/04_replit_downloads.png)
