...
Im Video wird erwähnt, dass Sie die Umgebung auf ```OTH-IM-DigitalSkills-Students``` umstellen müssen. Dies ist dieses Semester nicht mehr so, Sie können es bei ```Default```belassen.
...
Ein Rezept wird als neuer "Post" in einem Teams-Kanal wie folgt erstellt (Tipp: Sie können Teams von Microsoft herunterladen oder im Browser nutzen): 
...
Der **Inhalt** der Nachricht sollte das Rezept enthalten, kann aber ansonsten frei gestaltet werden. Der folgende Screenshot zeigt ein Beispiel einer solchen Nachricht:
...
2. Loggen Sie sich bei Microsoft Teams (ebenfalls mit ```abc12345@hs-regensburg.de```) ein (https://teams.microsoft.com/v2/)
3. Klicken Sie auf diesen [Teams-Kanal](https://teams.microsoft.com/l/channel/19%3Aa754b9a8c7284d4fa01fed50a04d85bd%40thread.tacv2/Lieblingsrezepte?groupId=368c3b39-de3f-4141-bc4e-1c5cf45dc956&tenantId=2c1b9b13-893c-42a5-bbc1-d7a1db5ddb54) und bitten um Zugriff auf das Team.
4. Sobald Sie den Zugriff erhalten haben (Sie erhalten eine Notification in Teams): Klicken Sie in Teams auf das Team "OTH_IM_DigitalSkills_Students"
4. Klicken Sie dort unter Hauptkanäle auf "Lieblingsrezepte". Eventuell finden Sie den Kanal unter "Ausgeblendete Kanäle".
...
**Tipps:**
* Verwenden Sie den Auslöser "Wenn eine neue Kanalnachricht eingetroffen ist" und die Aktion "E-Mail senden (V2)" (NICHT: "(V3)", da Sie dafür nicht vom IT-Zentrum freigeschaltet sind).
...
**Pro-Tipp:** Wenn Sie Ihren Flow in den Übungen vorzeigen, müssen Sie kein Video erstellen! Ergänzen Sie bei der Abgabe als Texteingabe den folgenden Text: "Flow in der Übung vom [Datum] bei [Name des Dozierenden] vorgestellt".
